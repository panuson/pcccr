		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<h1 class="m-0 text-dark">ข้อมูลพื้นฐาน</h1>
					<ol class="breadcrumb">
							...
							<table id="example" class="table table-bordered table-striped">
								<thead>
									<tr>
										...
										<th data-orderable="false" class="text-center" width="15%">ลำดับ</th>
										<th data-orderable="false" class="text-center" width="15%">จัดการ</th>
									</tr>
								</thead>
								<tbody>
									<?php foreach ($main->OrderBy('topic','ASC')->all() as $key => $value): ?>
									<tr>
										<td class="align-middle" >
											<a href="./?id=<?php echo $value['id']; ?>"><?php echo $value['topic'];?></a>
										</td>
										<td class="text-center align-middle">
											<a href="javascript:void(0)" data-sort="<?php echo $value['id']; ?>" data-no="<?php echo $value['no']; ?>" data-action="up" class="btn btn-info btn-sm"><i class="fa fa-chevron-up"></i></a>
											<a href="javascript:void(0)" data-sort="<?php echo $value['id']; ?>" data-no="<?php echo $value['no']; ?>" data-action="down" class="btn btn-info btn-sm"><i class="fa fa-chevron-down"></i></a>
										</td>
										<td class="text-center">
											<a class="btn btn-sm btn-warning rounded-circle" href="./?id=<?php echo $value['id']; ?>">
