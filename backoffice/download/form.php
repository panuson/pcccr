                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header">
                            <div class="text-right">
                                <a href="./list.php?type=<?php echo $type; ?>" class="btn btn-danger btn-sm">
                        ...
                        <div class="card-body">
                            <form action="control/command.php" enctype="multipart/form-data" method="POST" target="iframe">
                                <input type="hidden" name="download_id" value="<?php echo $type ?>">
                                ...
                                <div class="form-group text-center">
                                    <input name="save" class="btn btn-success btn-sm" value="บันทึก" type="submit">
                                </div>
                            </form>
                        </div>
                    </div>
