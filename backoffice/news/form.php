		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<h1 class="m-0 text-dark"><?php echo $ntopic; ?></h1>
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="../">แดชบอร์ด</a></li>
                        <li class="breadcrumb-item"><a href="./?type=<?php echo $type; ?>"><?php echo $ntopic; ?></a></li>
						<li class="breadcrumb-item active"><?php echo $htype; ?><?php echo $ntopic; ?></li>
					</ol>
				</div>
			</div>
			<!-- Main content -->
						...
						<div class="card-body">
                            <form action="control/command.php" method="POST" enctype="multipart/form-data" target="iframe" data-action="true">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo $topic; ?>" name="topic" type="text" class="form-control form-control-sm" id="topic" placeholder="หัวข้อข่าว" autocomplete="off" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mb-3"><a href="../../filesAttach/news/<?php echo $filename; ?>"><i class="fa fa-file"></i> ดูไฟล์แนบ</a></div>
                                    <div class="custom-file">
                                        <input name="filename1" type="file" data-type="jpg,jpeg,gif,pdf,doc,docx,xls,xlsx,zip,rar" class="custom-file-input" id="validatedCustomFile">
                                    ...
                                    <?php else: ?>
                                    <label for="filename1">ไฟล์แนบ ( เฉพาะไฟล์ .jpg, .jpeg, .pdf, .doc, .docx, .xls, .xlsx, .zip, .rar **แนะนำรูปกว้าง 1200px**  ขนาดไม่เกิน 20mb เท่านั้น )</label>
                                    <div class="custom-file">
                                        <input name="filename1" type="file" data-type="jpg,jpeg,gif,pdf,doc,docx,xls,xlsx,zip,rar" class="custom-file-input" id="validatedCustomFile">
                                        <label class="custom-file-label" for="validatedCustomFile">เลือกไฟล์...</label>
                                        <div class="invalid-feedback">กรุณาตรวจสอบไฟล์ของท่าน !! เฉพาะไฟล์ .jpg, .jpeg, .gif, .pdf, .doc, .docx, .xls, .xlsx, .zip, .rar *แนะนำรูปกว้าง 1200px**  ขนาดไม่เกิน 20mb เท่านั้น</div>
